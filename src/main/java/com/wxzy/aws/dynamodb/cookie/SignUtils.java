...
public class SignUtils {
    ...
    public static String sign(String secret, String method, String path,
        ...
        log.info("secret={},method={},path={},headers={},querys={},bodys={},signHeaderPrefixList={}",secret,method,path,headers,querys,bodys,signHeaderPrefixList);
        try {
